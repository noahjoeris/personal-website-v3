...
export function BlogComments({ slug }: BlogCommentsProps) {
  ...
  return (
    ...
    >
      ...
      <p className="mt-4 font-reading text-sm leading-relaxed text-foreground/70">
        Comments and reactions are stored in GitHub Discussions. A GitHub account is required to participate.{' '}
        <a
