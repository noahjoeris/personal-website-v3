  ...
  return (
    <section className="relative overflow-hidden bg-black lg:min-h-screen">
      ...
      <div className="relative h-[460px] w-full md:h-[620px] lg:absolute lg:inset-0 lg:z-10 lg:h-full">
        ...
        <div className="pointer-events-none absolute inset-x-0 bottom-0 z-[15] h-40 bg-gradient-to-b from-transparent via-black/6 to-black/18 md:h-48 lg:h-[24vh] lg:via-black/8 lg:to-black/16" />
      </div>
