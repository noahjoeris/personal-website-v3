...
export function LandingSection() {
  return (
    <section className="relative overflow-hidden bg-background lg:min-h-screen">
      ...
      <div className="absolute inset-x-0 top-0 h-[460px] bg-linear-to-br from-[hsl(182,30%,14%)] via-[hsl(182,30%,12%)] to-[hsl(185,25%,10%)] md:h-[620px] lg:hidden" />
      ...
      <div className="relative mt-3 h-[460px] w-full md:mt-0 md:h-[620px] lg:absolute lg:inset-0 lg:z-10 lg:h-full">
        ...
        <div className="pointer-events-none absolute inset-x-0 bottom-0 z-15 h-40 bg-linear-to-b from-transparent via-black/6 to-black/18 md:h-48 lg:h-[24vh] lg:via-black/8 lg:to-black/16" />
      </div>
